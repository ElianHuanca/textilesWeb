                ...
                data.forEach(item => {
                    ...
                    newListItem.innerHTML = `
                        <div class="row align-items-center">
                            ...
                            <div class="col text-truncate">
                                <a href="${baseUrl}/telas/${item.idtela}" class="text-body d-block"> Se requiere reposicionar Tela ${item.nombre}</a>
                                <div class="d-block text-muted text-truncate mt-n1">
                                    su stock de ${stock.toFixed(2)} es menor al ROP ${rop.toFixed(2)} se requiere reposicionar la tela
                                </div>
                            </div>
                        </div>`;
