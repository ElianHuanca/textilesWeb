                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="ganancias" type="text" class="form-control" name="ganancias"
                                    value="{{ $venta->ganancias }}" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="descuento" class="form-label">descuento</label>
                                <input id="descuento" type="text" class="form-control" name="descuento"
