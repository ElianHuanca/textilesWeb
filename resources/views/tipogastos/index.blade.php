        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-12 col-md-auto ms-auto d-print-none">
                    <!-- Botón para registrar una nueva tipogasto -->
                    <a href="{{ route('tipogastos.create') }}" class="btn btn-primary">
                        <!-- Icono de agregar tipogasto -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-footer d-flex align-items-center">
                            ...
                            <ul class="pagination m-0 ms-auto">
                                ...
                                @else
                                    <li class="page-item">
                                        <a class="page-link" href="{{ $tipogastos->previousPageUrl() }}" tabindex="-1"
                                            aria-disabled="true">‹</a>
                                    </li>
                                @endif

                                @foreach ($tipogastos->getUrlRange(1, $tipogastos->lastPage()) as $page => $url)
                                    <li class="page-item {{ $page == $tipogastos->currentPage() ? 'active' : '' }}">
                                        <a class="page-link" href="{{ $url }}">{{ $page }}</a>
                                    </li>
                                @endforeach

                                @if ($tipogastos->hasMorePages())
                                    <li class="page-item">
                                        <a class="page-link" href="{{ $tipogastos->nextPageUrl() }}">›</a>
                                    </li>
                                @else
                                    <li class="page-item disabled">
                                        <a class="page-link" href="#" tabindex="-1" aria-disabled="true">›</a>
